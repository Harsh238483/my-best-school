            ...
            >
              <div className="relative">
                {brandingData.logoUrl ? (
                  ...
                  <div className="h-8 w-8 sm:h-12 sm:w-12 rounded-full bg-gradient-to-r from-gold to-yellow-500 flex items-center justify-center animate-glow group-hover:scale-110 transition-transform duration-300">
